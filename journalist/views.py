    ...
    if request.method == "POST":
        ...
        if registration_type == 'journalist':
            ...
            message = (
                    ...
                    f"📧 Contact Us: info@middleeastbulletin.com\n"
                    f"🌐 Website: www.middleeastbulletin.com"
                )

            from_email = 'no-reply@middleeastbulletin.com'
        ...
        try:
            ...
            if journalist.status == "inactive":
                ...
                message = (
                    ...
                    f"If you have any concerns or questions, please do not hesitate to reach out to us at info@middleeastbulletin.com.\n\n"
