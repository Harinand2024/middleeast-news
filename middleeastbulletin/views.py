...
def get_user_agent(request):
    ...
    class UserAgent:
        def __init__(self, user_agent_string):
            ...
            self.is_mobile = self._is_mobile()
        ...
        def _is_mobile(self):
            ...
            user_agent = self.user_agent_string or ''
...
def home(request):
    ...
    seo=seo_optimization.objects.get(pageslug='https://www.middleeastbulletin.com')
    ...
    Category = category.objects.filter(cat_status='active').order_by('order')[:15]
...
# --------------video-post-manage--------------
    ...
    video=VideoNews.objects.filter(is_active='active',video_type='video').order_by('-id')[:4]
...
def AllvideoNews(request,slug):
    ...
    if slug == 'articles':
        ...
        blogdata=VideoNews.objects.filter(is_active='active').order_by('-id')
...
def videonewsdetails(request,slug):
    try:
        ...
        raise Http404("Video news not found")
    ...
    if request.method == "POST":
        ...
        try:
            ...
            send_mail(
                ...
                "no-reply@middleeastbulletin.com",
...
def Adsinquiry(request):
    ...
    if request.method == 'POST':
        ...
        from_email = 'no-reply@middleeastbulletin.comm'
...
Sitemap: https://www.middleeastbulletin.com/sitemap
