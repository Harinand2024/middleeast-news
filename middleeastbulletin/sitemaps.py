...
def custom_sitemap_index(request):
    ...
    sitemaps = [
        {'loc': 'https://www.middleeastbulletin.com/sitemap/news', 'lastmod': now},
        {'loc': 'https://www.middleeastbulletin.com/sitemap/videos', 'lastmod': now},
        {'loc': 'https://www.middleeastbulletin.com/sitemap/articles', 'lastmod': now},
        {'loc': 'https://www.middleeastbulletin.com/sitemap/images', 'lastmod': now},
        {'loc': 'https://www.middleeastbulletin.com/sitemap/archive', 'lastmod': now},
    ]
...
def sitemap_news(request):
    ...
    processed_news_items = [
        {
            'loc': f"https://www.middleeastbulletin.com{item.get_absolute_url()}",
            'lastmod': item.updated_at.strftime('%Y-%m-%dT%H:%M:%SZ'),
            'publication_name': 'middleeastbulletin',
            'language': 'en',
...
def sitemap_images(request):
    ...
    sitemap_list = [{'loc': f"https://www.middleeastbulletin.com/sitemap/images/{key}", 'lastmod': value} for key, value in sitemap_entries.items()]
...
def sitemap_images_by_month(request, year, month):
    ...
    sitemap_entries = [
        {
            'loc': f"https://www.middleeastbulletin.com{post.get_absolute_url()}",
            'image': f"https://www.middleeastbulletin.com{post.post_image.url}",
...
def sitemap_videos(request):
    ...
    sitemap_list = [{'loc': f"https://www.middleeastbulletin.com/sitemap/videos/{key}", 'lastmod': value} for key, value in sitemap_entries.items()]
    ...
    sitemap_entries = [
        {
            ...
            'thumbnail': f"https://www.middleeastbulletin.com{post.video_thumbnail.url}" if post.video_thumbnail else "",
            'lastmod': post.updated_at.strftime('%Y-%m-%dT%H:%M:%SZ'),
...
def sitemap_article(request):
    ...
    sitemap_list = [{'loc': f"https://www.middleeastbulletin.com/sitemap/articles/{key}", 'lastmod': value} for key, value in sitemap_entries.items()]
...
def sitemap_archive(request):
    ...
    sitemap_list = [{'loc': f"https://www.middleeastbulletin.com/sitemap/archive/{key}", 'lastmod': value} for key, value in sitemap_entries.items()]
